...
public class HTMLReportGenerator {
	 ...
	 * InterruptedException { TestSuiteStart("result\\extentreports\\aabidkar.html",
	 * "ejagruti"); TestCaseStart("this is test name", "this is description");
	 * StepDetails("pass", "this is step1", "this is step details1", "");
	 * StepDetails("fail", "this is step2", "this is step details2", "");
	 * TestCaseEnd(); TestSuiteEnd(); }
	 */
