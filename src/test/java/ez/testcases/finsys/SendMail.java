...
public class SendMail extends OperationsV1 {
 ...
 * 
 * @param FromEmailId
 *            - fromemailid@tosendmail.com
 * @param ToEmailId
 *            - wheretosend@email.com
 * @param LocalHost
 *            - smptp.gmail.com
 * @param Port
 *            - 465 / 587 (see what works for you)
 * @param FromEmailPassword
 *            - ejagruti
 * @param AttachemntDetails
 *            - location of attachment
 * @param Protocol
 *            - smtp
 */
/*
 * public static void SendReportThroughMail(final String FromEmailId, String
 * ToEmailId, String LocalHost, String Port, final String FromEmailPassword,
 * String AttachemntDetails,String Protocol) {
 * 
 * 
 * // Recipient's email ID needs to be mentioned. String to = ToEmailId;
 * 
 * // Sender's email ID needs to be mentioned String from =FromEmailId;
 * 
 ...
 * properties.put("mail.smtp.port", Port); //mail.smtp.starttls.enable="true"
 ...
 * "javax.net.ssl.SSLSocketFactory"); Authenticator authenticator = new
 * Authenticator() { protected PasswordAuthentication
 * getPasswordAuthentication() { return new
 * PasswordAuthentication(FromEmailId,FromEmailPassword); } };
 * 
 ...
 * filename = AttachemntDetails; DataSource source = new
